...
var run = function run(specFile) {
  ...
  var jestPath = _path2.default.normalize("" + __dirname + _path.sep + ".." + _path.sep + "node_modules" + _path.sep + "jest" + _path.sep + "bin" + _path.sep + "jest.js");
  var jestCmdConfig = "--passWithNoTests";
